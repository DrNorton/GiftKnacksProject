...
GO
PRINT N'Dropping unnamed constraint on [dbo].[Wishes]...';


GO
ALTER TABLE [dbo].[Wishes] DROP CONSTRAINT [DF__Wishes__Emergenc__571DF1D5];
...
GO
ALTER TABLE [dbo].[Wishes] ALTER COLUMN [Emergency] INT NULL;
