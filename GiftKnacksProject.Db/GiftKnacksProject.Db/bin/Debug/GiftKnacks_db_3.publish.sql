...
ALTER TABLE [dbo].[Contacts] WITH NOCHECK
    ADD CONSTRAINT [FK_Contacts_Profiles] FOREIGN KEY ([Id]) REFERENCES [dbo].[Profiles] ([Id]) ON DELETE CASCADE;
...
ALTER TABLE [dbo].[Profiles] WITH NOCHECK
    ADD CONSTRAINT [FK_Profiles_USERS] FOREIGN KEY ([Id]) REFERENCES [dbo].[Users] ([Id]) ON DELETE CASCADE;
